-- Clientes (id_cliente: 1, 2)
INSERT INTO clientes (nombre, correo) VALUES
('Ana Torres', 'ana@example.com'),
('Luis Pérez', 'luis@example.com');

-- Productos (id_producto: 1, 2, 3)
INSERT INTO productos (nombre, precio) VALUES
('Laptop', 1200.00),
('Mouse', 25.50),
('Teclado', 45.00);

-- Pedidos (id_pedido: 1, 2)
...
-- Datos Grafos (ciudades) (ID 1:SLP, 2:Querétaro, 3:Guadalajara, 4:Monterrey, 5:CDMX)
